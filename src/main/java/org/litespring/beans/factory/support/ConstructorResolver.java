...
public class ConstructorResolver {
    ...
    private ConfigrableBeanFactory beanFactory;

    public ConstructorResolver(ConfigrableBeanFactory beanFactory) {
    ...
    public Object autowireConstructor(final BeanDefinition bd){
        ...
        try {
            ...
            throw new BeanCreationException(bd.getID(), "instantiotion fail");
        }
